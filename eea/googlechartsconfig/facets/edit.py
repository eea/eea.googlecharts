...
class EditForm(SubPageForm):
    """
    Basic layer to edit googlechart facets. For more details on how to use this,
    see implementation in eea.googlechartsconfig.facets.text.edit.Edit.
    ...
    def nextUrl(self):
        ...
        to = self.context.absolute_url() + '/googlechart-edit.html'
