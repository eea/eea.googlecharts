...
from eea.googlechartsconfig.facets.interfaces import IGoogleChartAddFacet
...
class AddForm(SubPageForm):
    """
    Basic layer to add googlechart facets. For more details on how to use this,
    see implementation in eea.googlechartsconfig.facets.text.add.Add.

    Assign these attributes in your subclass:
      - form_fields: Fields(Interface)

    """
    form_fields = Fields(IGoogleChartAddFacet)
    _prefix = 'form'
    _action = ''
    ...
    def nextURL(self):
        ...
        nexturl = self.context.absolute_url() + '/googlechart-edit.html'
