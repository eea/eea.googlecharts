...
class Configure(object):
    """ Get googlechart configuration
    """
    implements(IGoogleChartConfig)
    ...
    @property
    def views(self):
        """ Return googlechart enabled views
        """
        anno = IAnnotations(self.context)
    ...
    @property
    def facets(self):
        """ Return googlechart enabled facets
        """
        anno = IAnnotations(self.context)
    ...
    @property
    def sources(self):
        """ Return googlechart external sources
        """
        anno = IAnnotations(self.context)
    ...
    def add_facet(self, name, **kwargs):
        ...
        config = self._facets()
        kwargs.update({'name': name})
        kwargs.setdefault('type', u'googlechart.list.facet')
